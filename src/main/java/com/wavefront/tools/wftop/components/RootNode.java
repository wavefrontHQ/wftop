...
public class RootNode implements Node<SourceNode> {
    ...
    public void accept(Dimension analysisDimension, boolean groupByIngestionSource,
           boolean accessed, String metric, String host, Multimap<String, String> pointTags, long timestamp, double value){
        ...
        if (groupByIngestionSource) {
            ...
            if (ingestionSource.get(source_value) == null){
                ...
                ingestionSource.get(source_value).getNamespaceBuilder().setSeparatorCharacters(getSeparatorCharacters());
                ingestionSource.get(source_value).getNamespaceBuilder().setMaxDepth(getMaxDepth());
                ingestionSource.get(source_value).getNamespaceBuilder().setMaxChildren(getMaxChildren());
            }
        }
    ...
    public void setSeparatorCharacters(String separators) { //need to set namespace seperators
